...
KO_DOCKER_REPO=manaswinig/golang-autoect KO_DEFAULTBASEIMAGE=manaswinig/golang-auto:base ko build --bare -t v1 . (change your image names here)
```
...
docker run -d \
  ...
  -e DB_NAME=mydb \
  -e SSL=disable \
 ttl.sh/golang-autoect-1a3a3957a5f042748486580be307ed8e@sha256:9ae320cdf05700210dd50ebefa6b3cd4a11ca2feaad1946f6715e0ec725bda62
```
...
```ksctl switch-cluster --provider azure --region eastus --name golang-autoect```
